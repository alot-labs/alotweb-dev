...
<section class="section hero hero--prize-draw">
    <div class="container">
        <div class="hero__holder">
            <h2 class="heading-4">We reward your customers with <br>free chances to win our £1 Million</h2>
            <h1 class="heading-1">Free prize draws</h1>
        ...
        <div class="achievements__holder">
            ...
            <div class="achievements__item">
                <div class="achievements__text-holder">
                    ...
                    <p class="paragraph">Prize Promotions create Brand awareness and is influential in Brand switching, encouraging customers to try your product over the competition.</p>
                </div>
            </div>
            <div class="achievements__item">
                <div class="achievements__text-holder">
    ...
    <div class="container">
        <div class="image-with-description__holder">
            <div class="image-with-description__plate image-with-description__plate--blue">
                ...
                <p class="image-with-description__text">Are you marketing your services by offering potential customers a chance to win exciting prizes? How about offering €1Million cash or a prize equivalent instead of a mobile phone? There are no limits to your imagination.</p>
            </div>
    ...
    <div class="container">
        <div class="heading-holder heading-holder--extended-mobile-margin">
            <div class="heading-holder__item">
                ...
                <p class="paragraph">Contact us to discuss how our &euro;1 Million<br> free to enter prize draws can drive your business.</p>
