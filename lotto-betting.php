...
<section class="section hero hero--lotto-betting">
    <div class="container">
        <div class="hero__holder">
            <h1 class="heading-1">Lottery Betting <br>Solutions</h1>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="overplate-text__plate overplate-text__plate--green">
            <div class="overplate-text__column">
                <p class="paragraph paragraph--bold">Lottery betting involves making a bet on the outcome of an official lottery draw. Players pick which lottery draw to bet on and which lottery balls (numbers) they think will be drawn - if they guess correctly, they win cash&nbsp;prizes.</p>
            </div>
            <div class="overplate-text__column">
    ...
    <div class="container">
        <div class="overprint-image__holder">
            ...
            <div class="overprint-image__text-holder">
                ...
                <p class="paragraph">You get more freedom with lottery betting. You can offer players to bet on the outcome of lottery draws from around the globe, all in one place and extend the gaming experience with unique features, unseen in traditional lotteries, such as:</p>
