            ...
            <div class="products-services__column">
                <div class="products-services__item">
                    ...
                    <div class="products-services__item-body">
                        ...
                        <a href="lotto-betting.php" class="button button--blue">Lotto betting</a>
                    </div>
                </div>
                <div class="products-services__item">
                    <div class="products-services__item-header">
                    ...
                    <div class="products-services__item-body">
                        ...
                        <a href="omnichannel-lottery.php" class="button button--blue">Omnichannel Systems</a>
                    </div>
                </div>
            </div>
            <div class="products-services__column">
                <div class="products-services__item">
                    ...
                    <div class="products-services__item-body">
                        ...
                        <a href="risk-management.php" class="button button--blue">Risk management</a>
                    </div>
                </div>
                <div class="products-services__item">
                    <div class="products-services__item-header">
                    ...
                    <div class="products-services__item-body">
                        ...
                        <a href="gaming-content.php" class="button button--blue">Game content</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="heading-holder">
            ...
            <div class="heading-holder__item heading-holder__item--right desktop-only">
                <a href="news.php" class="button button--blue">More news</a>
            </div>
        </div>
        <div class="news__holder">
            <div class="news__item">
                <div class="article-preview">
                    <a class="article-preview__image" style="background-image: url(i/news-1.jpg);" href="article.php"></a>
                    <div class="article-preview__text">
                        <p class="article-preview__date">Athens, 1<sup>st</sup> of August, 2019</p>
                        <h3 class="heading-2">
                            <a href="article.php">ALOT signs Intralot</a>
                        </h3>
            ...
            <div class="news__item">
                <div class="article-preview">
                    <a class="article-preview__image" style="background-image: url(i/news-2.jpg);" href="article.php"></a>
                    <div class="article-preview__text">
                        <p class="article-preview__date">Gibraltar, 18<sup>th</sup> of July, 2019</p>
                        <h3 class="heading-2">
                            <a href="article.php">JackpotJoy launches with ALOT</a>
                        </h3>
